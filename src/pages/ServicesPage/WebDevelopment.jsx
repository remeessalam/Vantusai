    ...
    <div className="flex flex-col gap-10 text-white">
      ...
      <div className="flex flex-col gap-4 md:px-5">
        ...
        <h3 data-aos="fade-up" className="text-xl font-medium mt-2">
          Vantus AI Solutions LLP - Crafting Digital Experiences
        </h3>
        ...
        <p data-aos="fade-up" className="description">
          ...
          Vantus AI Solutions LLP, we build custom websites that are crafted to
          meet the unique needs of your business. Whether you need a dynamic
