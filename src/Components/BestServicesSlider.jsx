  ...
  return (
    <section className="py-[5rem] relative">
      ...
      <div className="wrapper text-center ">
        ...
        <h1 className="main-heading capitalize mb-8 text-white">
        ...
        <div className="flex items-center gap-3 md:gap-10">
          ...
          <div data-aos="fade-up" ref={sliderRef} className="keen-slider">
            {allServices.map(({ description, title, link, img, id, icon }) => (
              <Link to={link} key={id} className="relative pb-[2rem]">
                ...
                >
                  ...
                  <img
                    loading="lazy"
                    src={img}
                    className="w-[90%] object-contain rounded-3xl"
                    alt=""
                  />
                  <h3 className="text-[1.5rem] text-black font-semibold my-5 leading-tight">
                    {title}
                  </h3>
